...
> The first release: the smallest version of mine-flow that delivers the core value and
> is usable. See `prompts/STEP-index.md` for the live roadmap and
> `Code/mine-flow-docs/architecture/*-phasing-roadmap.md` for the phase plan.
