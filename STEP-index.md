...
| 43.2 | Android Build Chain Upgrade | Done | `android/settings.gradle.kts`: AGP `9.0.1` → `9.1.0`; KGP `2.3.20` → `2.4.0`; `android/app/build.gradle.kts`: explicit `minSdk = 23` |
...
| 43.5 | flutter_secure_storage v11 Upgrade | Done | `pubspec.yaml`: `^9.2.4` → `^11.0.0`; `secure_storage_service.dart`: removed obsolete `encryptedSharedPreferences`; `build.gradle.kts`: `minSdk = 23` |
