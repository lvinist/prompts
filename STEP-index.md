...
| STEP-25 | Phase 2 UI pass - ReportDashboardPage       |             | In progress | `mine-flow-app`                   | Phase 2 styling, markup, and shadcn-admin conventions for ReportDashboardPage. Substeps: 25.1 craft, 25.2 polish, 25.3 audit. Branch: `step-0025-phase2-reportdashboardpage`.             |
...
| 25.2    | Polish (Animations & Details)      |        |                                                                                                                                                                                                                                                                     |
| 25.3    | Audit (Cross-check & Consistency)  |        |                                                                                                                                                                                                                                                                     |
