...
| 44.2    | RLS / authorization behavior audit                             | Planned     | Findings in S0 report; optional `supabase/migrations/YYYYMMDD_step_44_rls_gaps.sql` |
| 44.3    | Account lifecycle verification                                 | Planned     | Findings in S0 report |
| 44.4    | Privacy notice (in-app) gap check                              | Planned     | Risk register entry RISK-0011; S0 report section |
| 44.5    | Secrets posture audit                                          | Planned     | Findings in S0 report; `.env.example` verified or updated |
| 44.6    | Backup / restore fire-drill record                             | Planned     | Risk register entry RISK-0012; S0 report section |
| 44.7    | S0 baseline report & risk / security-reviews registry update   | Planned     | `reports/security/2026-08-26-step-0044-s0-security-baseline-report.md`; `registries/risks.yml`; `registries/security-reviews.yml` |
| 44.8    | Architecture doc update & STEP close                           | Planned     | Doc 06 v0.2.0; STEP-44 Done in index; branches merged; plan archived |
