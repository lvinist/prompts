...
| # | Title | Status | Evidence |
|---|-------|--------|----------|
| 49.0 | Upstream recon: clone, verify layout, map the five guards to landing sites | Planned | — |
